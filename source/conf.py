...
project = 'Spinx GitHub Pages example'
...
htmlhelp_basename = 'SpinxGitHubPagesexampledoc'
...
latex_documents = [
    (master_doc, 'SpinxGitHubPagesexample.tex', 'Spinx GitHub Pages example Documentation',
...
man_pages = [
    (master_doc, 'spinxgithubpagesexample', 'Spinx GitHub Pages example Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SpinxGitHubPagesexample', 'Spinx GitHub Pages example Documentation',
     author, 'SpinxGitHubPagesexample', 'One line description of project.',
     'Miscellaneous'),
]
